                    ...
                    <div class="collapse navbar-collapse" id="main-nav">  
                        ...
                        <ul class="nav navbar-nav navbar-user">
                            ...
                            <div class="retain-login">
               					<input type="checkbox" >
                                <strong> Remember Login </strong>                            </div>
                        </ul>
                        <ul class="nav navbar-nav navbar-user">
                            <!-- Remember Login -->
                            <div class="login-cmd">
      ...
      <!-- Sidebar component with st-effect-1 (set on the toggle button within the navbar) -->
                            ...
                            <div class="center">
                                ...
                                <form class="signup-form" id="signupform" onSubmit="return false">
                                    ...
                                    <select id="day" onFocus="emptyElement('status')">
                                    	<?php include_once("../includes/day_list.php"); ?>
                                    </select>
                                    ...
                                    <select id="year" onFocus="emptyElement('status')">
                                    	<?php include_once("../includes/year_list.php"); ?>
                                    </select>
                                    <div></div>
            ...
            <footer class="footer">
            	<ul class="languaje_list">
                    <li>English (US)</li>
                    <li>
                    	<a dir="ltr" href="../index.php?language=es" onClick="setLocalCookie(&quot;es_LA&quot;, &quot;en_US&quot;, &quot;http:\/\/es-la.qhdc.com\/&quot;, &quot;qhdc_Language&quot;, 1); return false;" title=	 "Spanish">Español</a>
                    </li>
                    <li>
                    	<a dir="ltr" href="../index.php?language=pt" onClick="setLocalCookie(&quot;pt_BR&quot;, &quot;en_US&quot;, &quot;http:\/\/pt-br.qhdc.com\/&quot;, &quot;qhdc_Language&quot;, 4); return false;" title="Portuguese">Português</a>
                    </li>
                    <li>
                    	<a dir="ltr" href="../index.php?language=it" onClick="setLocalCookie(&quot;it_IT&quot;, &quot;en_US&quot;, &quot;http:\/\/it-it.qhdc.com\/&quot;, &quot;qhdc_Language&quot;, 5); return false;" title="Italian">Italiano</a>
                    </li>
                    <li></li>
                    <li class="pull-right">
