<?php
	...
	include_once("includes/encryption/Crypto.php");
...
//	
	...
	$message = "Hello I am the new 00012fdgshhdjjhgetwrrsfaklpo987s87s6d73625 robot";

	echo "Original Message \n";
	echo $message;
	echo "\n";

	$crypted_mess = Crypto::encrypt($message, $key);
	...
	$decrypted_mess = Crypto::decrypt($crypted_mess, $key);
	echo $decrypted_mess;
