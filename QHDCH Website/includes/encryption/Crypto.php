<?php
	...
	include_once("KeyOrPassword.php");
	include_once("RuntimeTests.php");
	include_once("EnvironmentIsBrokenException.php");
	include_once("WrongKeyOrModifiedCiphertextException.php");
		...
		public static function legacyDecrypt($ciphertext, $key)
			{
				...
				if (Core::ourStrlen($ciphertext) <= Core::LEGACY_MAC_BYTE_SIZE) 
					{
						throw new EWrongKeyOrModifiedCiphertextException(
